...
- (void)viewDidLoad {
    ...
    //水平图片
    QJKJImageAutoCycleScroll *horizontalImageCycleScroll = [[QJKJImageAutoCycleScroll alloc] initWithFrame:CGRectMake(0, 64 + 20, [UIScreen mainScreen].bounds.size.width, 200) withScrollDirection:QJKJScrollHorizontal];
